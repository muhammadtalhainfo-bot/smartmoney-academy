  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080808', color: 'white', fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        ...
        .card-pro { background: linear-gradient(135deg, rgba(212,168,67,0.06) 0%, rgba(212,168,67,0.02) 100%); border: 1px solid #E8C547; }
        .card-free { background: #111111; border: 1px solid rgba(255,255,255,0.18); }
      ...
      <section style={{ padding: '80px 24px 60px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', position: 'relative' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '5px 14px', borderRadius: '100px', border: '1px solid var(--border)', background: 'rgba(212,168,67,0.04)', fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.15em', color: '#E8C547', marginBottom: '24px' }}>
      ...
      <section style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px 80px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '24px', alignItems: 'start' }}>
        ...
        <div className="card-pro" style={{ borderRadius: '20px', padding: '36px', position: 'relative', overflow: 'hidden' }}>
          ...
          {/* POPULAR BADGE */}
          <div style={{ position: 'absolute', top: '20px', right: '20px', background: 'linear-gradient(135deg,#E8C547,#8A6B28)', borderRadius: '6px', padding: '4px 12px', fontFamily: 'DM Mono, monospace', fontSize: '10px', color: 'black', fontWeight: 600, letterSpacing: '0.1em' }}>POPULAR</div>

          <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '11px', letterSpacing: '0.2em', color: '#E8C547', marginBottom: '16px' }}>PRO ACCESS</div>
          ...
          {annual && (
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '11px', color: 'rgba(255,255,255,0.7)', marginBottom: '4px' }}>
              Billed as <span style={{ color: '#E8C547' }}>${annualPrice}/year</span>
            </div>
          )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {PRO_FEATURES.map((f, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ fontSize: '14px', color: '#E8C547', flexShrink: 0 }}>✓</span>
      ...
      <section style={{ padding: '0 24px 80px', textAlign: 'center' }}>
        <div style={{ maxWidth: '500px', margin: '0 auto', padding: '48px', background: 'rgba(212,168,67,0.04)', border: '1px solid rgba(232,197,71,0.95)', borderRadius: '20px' }}>
          ...
          <Link href="/auth" style={{ display: 'inline-block', padding: '14px 36px', background: 'linear-gradient(135deg,#E8C547,#8A6B28)', borderRadius: '10px', color: 'black', textDecoration: 'none', fontFamily: 'DM Mono, monospace', fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600 }}>
            CREATE FREE ACCOUNT →
          </Link>
        </div>
      </section>
