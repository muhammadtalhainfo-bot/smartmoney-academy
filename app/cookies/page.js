  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080808', color: 'white', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Cookies We Use</h2>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Third Party Cookies</h2>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Managing Cookies</h2>
