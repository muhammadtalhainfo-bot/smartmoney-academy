...
const TESTIMONIALS = [
  {
    ...
    avatar: 'A',
    color: '#6366F1',
    text: 'Finally understood what FVGs actually are after 2 years of confusion. The way SmartMoney Academy breaks down ICT concepts is cleaner than anything on YouTube. Module 3 alone changed how I see every chart.',
  ...
  },
  {
    ...
    avatar: 'D',
    color: '#10B981',
    text: 'I\'ve paid for multiple trading courses. SmartMoney Academy covers more ICT content for free than courses I paid $300+ for. The order blocks module is exceptional.',
...
export default function Testimonials() {
  return (
    <section style={{ padding: '80px 24px', borderTop: '1px solid rgba(212,168,67,0.1)', position: 'relative', overflow: 'hidden' }}>
