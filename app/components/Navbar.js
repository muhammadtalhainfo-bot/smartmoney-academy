    ...
    <>
      ...
      {menuOpen && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 50, background: 'rgba(8,8,8,0.98)', backdropFilter: 'blur(20px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '24px', overflowY: 'auto', padding: '80px 0 40px' }}>
          ...
          <div style={{ fontFamily: "'DM Mono', monospace", fontSize: '9px', letterSpacing: '0.3em', color: 'rgba(212,168,67,0.75)', textTransform: 'uppercase' }}>// LEARN</div>
          ...
          <div style={{ fontFamily: "'DM Mono', monospace", fontSize: '9px', letterSpacing: '0.3em', color: 'rgba(212,168,67,0.75)', textTransform: 'uppercase', marginTop: '8px' }}>// TOOLS & MORE</div>
          {MORE_NAV.map(([href, label]) => (
