...
export const metadata = {
  ...
  description: 'Master ICT (Inner Circle Trader) and Smart Money Concepts for free. Learn market structure, liquidity, fair value gaps, order blocks, killzones and more. 28 modules, 80+ lessons.',
  ...
  openGraph: {
    ...
    description: 'Master ICT & Smart Money Concepts for free. 28 modules, 80+ lessons. Learn to trade like institutions.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'ICT Flow — Trade Like Institutions' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'ICT Flow — Free ICT Trading Education',
    description: 'Master ICT & Smart Money Concepts for free. 28 modules, 80+ lessons.',
    images: ['/og-image.png'],
...
const jsonLd = {
  ...
  name: 'ICT Flow',
  url: 'https://ictflow.com',
  description: 'Free ICT and Smart Money Concepts trading education platform. 28 modules, 80+ lessons.',
