      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ background: '#0F0F0F', border: '1px solid rgba(212,168,67,0.22)', borderRadius: '20px', padding: '36px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {/* Email */}
            <div>
              <label style={{ fontFamily: 'DM Mono', fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.7)', display: 'block', marginBottom: '8px' }}>Email</label>
