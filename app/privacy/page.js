    ...
    <div style={{ minHeight: '100vh', background: '#080808', color: 'white', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '11px', color: 'rgba(255,255,255,0.6)', marginBottom: '48px' }}>Last updated: March 2026</div>
          ...
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Information We Collect</h2>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Third Party Services</h2>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Your Rights</h2>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#D4A843', marginBottom: '12px', letterSpacing: '0.05em' }}>Contact</h2>
